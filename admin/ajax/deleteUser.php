...
if(isset($_POST['idBoleta'])!= "")
{
   ...
   //$queryT="(ALTER TABLE "materia_seleccionadas" DROP FOREIGN KEY "fk_numBoleta_seleccionadas")"
    //$queryT2="ALTER TABLE `materia_seleccionadas` ADD CONSTRAINT `fk_numBoleta_seleccionadas` FOREIGN KEY (`fk_numBoleta_seleccionadas`) REFERENCES `usuarios` (`numBoleta`) ON DELETE CASCADE; "; 
